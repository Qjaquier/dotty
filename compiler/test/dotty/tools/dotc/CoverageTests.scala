...
class CoverageTests extends ParallelTesting {
  ...
  @Test def coverageT: Unit = {
    implicit val testGroup: TestGroup = TestGroup("compileCoverage")
    compileFile("tests/coverage/CoverageEx.scala", defaultOptions).checkCompile()//.checkExpectedErrors()//.and("-coverage", "C:\\Users\\Tibert\\Documents\\GitHub\\"))
